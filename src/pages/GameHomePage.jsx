...
import { FiArrowLeft, FiPlay, FiX, FiAlertCircle } from "react-icons/fi";
...
function GameHomePage() {
  ...
  const details = game ? gameDetails[game.id] : null;
    ...
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerBalances}>
          <div className={styles.headerTokenBalance}>
        ...
        <section className={styles.gameCard}>
          ...
          <div className={styles.gameInfo}>
            <div>
              ...
              <p>
                {details?.description || "Explore this game and earn rewards."}
              </p>
            </div>
      ...
      {showInsufficient && (
        <div className={styles.modalOverlay} onClick={closeInsufficient}>
          <div
          ...
          >
            ...
            <span className={styles.modalLabel}>GAME ENTRY</span>

            <h2>Not Enough Tokens</h2>

            <p>
              You need <strong>{PLAY_COST} Tokens</strong> to play {game.name}.
            </p>
